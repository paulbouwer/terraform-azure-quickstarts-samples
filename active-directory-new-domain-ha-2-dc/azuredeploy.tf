...
variable "config" {
  ...
  default = {
    ...
    "create_pdc_script_path"        = "/DSC/CreateADPDC.ps1.zip"
    "prepare_bdc_script_path"       = "/DSC/PrepareADBDC.ps1.zip"
    "configure_bdc_script_path"     = "/DSC/ConfigureADBDC.ps1.zip"
